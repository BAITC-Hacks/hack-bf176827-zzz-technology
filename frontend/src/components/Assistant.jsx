...
export default function Assistant({selected, onDisable, onHighlight, onSelect}) {
  ...
  async function ask(event) {
    ...
    try {
      const result = await request('/v1/assistant', {method: 'POST', headers: {'Content-Type': 'application/json'}, body: JSON.stringify({question: question.trim(), gid: selected || undefined})});
